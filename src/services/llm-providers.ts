...
export const LLM_PROVIDERS: LLMProviderPreset[] = [
  ...
  },
  {
    ...
    models: ['doubao-seed-1.6-flash', 'doubao-seed-1.6', 'doubao-seed-1.6-thinking', 'deepseek-v4-flash', 'deepseek-r1-0528'],
...
export const ASR_CLOUD_PROVIDERS: ASRCloudProviderPreset[] = [
  ...
  },
  {
    ...
    models: ['fun-asr-realtime', 'qwen3-asr-flash-realtime'],
