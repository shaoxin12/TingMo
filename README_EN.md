...
<p align="center">
  <strong>A Windows desktop AI voice input tool. Press a hotkey, speak, and your words are typed directly at the cursor.</strong>
</p>
...
TingMo is a Windows desktop AI voice input tool. Press a hotkey in any app — chat, documents, email, browser — speak, and your words are transcribed and typed at the cursor. No window switching, no manual pasting.

Unlike mainstream AI input methods, TingMo is **vendor-independent**: ASR (speech recognition) and LLM (language model) providers are freely selectable. It can run **fully offline** with the local SenseVoiceSmall model — your data stays on-device. Lightweight system tray app — no skins, no pop-ups, no ads.
